...
int main() {
  ...
  pid.Init(0.1, 0.001, 1.0);    // for 0.3 throttle value
  // pid.Init(0.135,0.001,1.5);      // for 0.4 throttle value
  // pid.Init(0.135,0.0015,1.8);     // for 0.5 throttle value
  
  // speed_pid.Init(0.2,0.002,0.0);
    ...
    if (length && length > 2 && data[0] == '4' && data[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // double err_speed = speed - desired_speed;
